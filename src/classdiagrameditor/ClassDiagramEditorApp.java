...
public class ClassDiagramEditorApp extends javax.swing.JFrame {
    ...
    private void menuItemNewProjectActionPerformed(java.awt.event.ActionEvent evt) {                                                   
    ...
    private void menuItemOpenProjectActionPerformed(java.awt.event.ActionEvent evt) {                                                    
    ...
    private void menuItemSaveProjectActionPerformed(java.awt.event.ActionEvent evt) {                                                    
    ...
    private void menuItemCloseProjectActionPerformed(java.awt.event.ActionEvent evt) {                                                     
    ...
    private void menuItemDeleteProjectActionPerformed(java.awt.event.ActionEvent evt) {                                                      
    ...
    private void menuItemAddDiagramActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        addTab();
    }                                                  
    ...
    private void menuItemDeleteSelectionActionPerformed(java.awt.event.ActionEvent evt) {                                                        
    ...
    private void menuItemAddDependencyActionPerformed(java.awt.event.ActionEvent evt) {                                                      
        menuItemAddDependency.setOpaque(true);
    ...
    private void menuItemAddAssociationActionPerformed(java.awt.event.ActionEvent evt) {                                                       
    ...
    private void menuItemAddCompositionActionPerformed(java.awt.event.ActionEvent evt) {                                                       
        menuItemAddDependency.setOpaque(false);
        menuItemAddAssociation.setOpaque(false);
    ...
    private void menuItemAddAggregationActionPerformed(java.awt.event.ActionEvent evt) {                                                       
        menuItemAddDependency.setOpaque(false);
        menuItemAddAssociation.setOpaque(false);
        menuItemAddComposition.setOpaque(false);
    ...
    private void menuItemAddInheritanceActionPerformed(java.awt.event.ActionEvent evt) {                                                       
        menuItemAddDependency.setOpaque(false);
        menuItemAddAssociation.setOpaque(false);
        menuItemAddComposition.setOpaque(false);
        menuItemAddAggregation.setOpaque(false);
